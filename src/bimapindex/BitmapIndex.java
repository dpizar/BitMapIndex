...
import bimapindex.BICriteria.Operator;
import bimapindex.BIKey.BIGroup;
...
public class BitmapIndex {
	 ...
	 * @return
	 */
	public HashMap<BIKey, EWAHCompressedBitmap> getBiMaps()
	{
		return this.bitmaps;
	}
	/**
	 * Getter for emptyBitmaps.
	 * @return
	 */
	public HashMap<BIGroup, EWAHCompressedBitmap> getEmptyBiMaps()
	{
		return this.emptyBitmaps;
	}
	/**
	 * Getter for the number of bits set to true in the hashmap..
	 * @return
	 */
